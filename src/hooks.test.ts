...
describe("handleSessionStart", () => {
  ...
  test("injects Ghost briefing with search-first guidance", async () => {
    ...
    expect(context).toContain("ALWAYS search Ghost before reading code");
    expect(context).toContain("deep_search");
